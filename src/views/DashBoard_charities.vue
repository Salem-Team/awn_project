  ...
  <div class="Dash_board">
    ...
    <v-container fluid>
      <v-row>
        <v-col cols="12">
          <div
            class="d-flex justify-space-between align-center flex-wrap px-12"
            style="
              position: relative;
          ...
          <v-item-group selected-class="bg-primary">
            <v-container>
              <v-row class="mydailog justify-center">
                <v-col cols="12" class="d-flex justify-center ga-6">
                  <v-item>
                    <v-card
                      ...
                      @click="toggle"
                    >
                      <div class="text-h3 flex-grow-1 text-center">اضافه</div>
                    </v-card>
                  </v-item>
                  <v-item>
                    <v-card
