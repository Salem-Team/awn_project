    ...
    <v-container class="form_container mt-4">
      ...
      <form ref="form" @submit.prevent="validateForm" class="ma-auto">
        ...
        <v-textarea
          ...
          :error-messages="v$.user.describetion.$errors.map((e) => e.$message)"
        ...
        <div class="d-flex align-center flex-wrap !w-full">
          ...
          <v-text-field
            ...
            :error-messages="
              v$.user.license_number.$errors.map((e) => e.$message)
            "
            label="رقم الشهره"
          ></v-text-field>
          <!--year input-->
          <v-text-field
            ...
            name="year"
            v-model="user.year"
            :error-messages="v$.user.year.$errors.map((e) => e.$message)"
            label="لسنة"
          ></v-text-field>
        </div>
