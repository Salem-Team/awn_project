    ...
    <v-container class="form_container mt-4">
      ...
      >
        ...
        <v-text-field
          ...
          label="اسم الجمعية"
          class="mt-2"
          :error-messages="v$.Charities.title.$errors.map((e) => e.$message)"
        ></v-text-field>
        <!--phone input-->
        <v-text-field
          ...
          type="tel"
          variant="outlined"
          :error-messages="v$.Charities.phone.$errors.map((e) => e.$message)"
        ></v-text-field>
        <!--describetion input-->
        <v-textarea
          row-height="15"
        ...
        <v-text-field
          ...
          :error-messages="v$.Charities.address.$errors.map((e) => e.$message)"
        ></v-text-field>
        <div class="d-flex align-center flex-wrap !w-full">
          ...
          <v-text-field
            ...
            :error-messages="
              v$.Charities.Fame_number.$errors.map((e) => e.$message)
            "
            label="رقم الشهره"
          ></v-text-field>
          <!--year input-->
          <v-text-field
            ...
            :error-messages="
              v$.Charities.Fame_year.$errors.map((e) => e.$message)
            "
            label="لسنة"
          ></v-text-field>
        </div>
        ...
        <v-text-field
          ...
          variant="outlined"
          :error-messages="
            v$.Charities.Social_media.$errors.map((e) => e.$message)
          "
        ></v-text-field>
        ...
        <v-chip-group
          ...
          :error-messages="
            v$.Charities.Charities_specialty.$errors.map((e) => e.$message)
          "
        >
          <v-chip
            elevation="2"
        ...
        <v-text-field
          ...
          type="tel"
          variant="outlined"
          :error-messages="v$.user.phones.$errors.map((e) => e.$message)"
        ></v-text-field>
        ...
        <v-text-field
          ...
          label="تاريخ الميلاد"
          class="mt-2"
          :error-messages="v$.user.birthday.$errors.map((e) => e.$message)"
        ></v-text-field>
        <v-text-field
          v-model="user.email"
          type="email"
        ...
        <v-text-field
          ...
          label="الرقم القومي"
          class="mt-2"
          :error-messages="v$.user.nationalID.$errors.map((e) => e.$message)"
        ></v-text-field>
        <v-text-field
        ...
        ></v-text-field>
        <v-btn class="me-4" type="submit" style="width: 100%; font-size: 25px">
          تم
        </v-btn>
      </form>
    </v-container>
  ...
  validations() {
    return {
      ...
      user: {
        ...
        nationalID: {
          required: helpers.withMessage("ادخل الرقم القومي ", required),
          numeric: helpers.withMessage(" ادخل أرقام فقط", numeric),
          minLength: helpers.withMessage(
        ...
        birthday: {
          required: helpers.withMessage("ادخل تاريخ الميلاد", required),
        },
        gender: {
          required,
        },
    ...
    async validateForm() {
      ...
      if (dataExists) {
        ...
        if (!this.v$.$error) {
          ...
          // this.Add_Charities(); // Uncomment this line if you want to submit the form
        } else {
